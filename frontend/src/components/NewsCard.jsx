    ...
    <div className="bg-white shadow-lg rounded-lg overflow-hidden transform hover:scale-105 transition-transform duration-300 hover:shadow-2xl max-w-sm mx-auto">
      ...
      <div className="p-4">
        ...
        <h2
          ...
          title={article.title.length > 50 ? article.title : undefined} // Tooltip for longer titles
        >
          {article.title}
        </h2>
        ...
        <div className="flex items-center justify-between">
          ...
          <a
            ...
            className="inline-block bg-gray-800 text-white px-4 py-2 rounded-md shadow-md hover:scale-105 hover:bg-gray-700 transition-all duration-300 ease-in-out" onClick={onReadMore}
          >
            Read More
          </a>
        </div>
